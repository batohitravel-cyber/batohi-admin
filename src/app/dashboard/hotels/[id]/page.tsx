...
import { getHotelById, updateHotel } from '@/lib/hotels-actions';
...
export default function EditHotelPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const { hotel, error } = await getHotelById(parseInt(id));

            if (error) {
                toast({
                    title: "Error fetching hotel",
                    description: error,
                    variant: "destructive",
                });
            ...
            if (hotel) {
                setFormData({
                    ...
                    price_per_night: hotel.price_per_night ? String(hotel.price_per_night) : '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const result = await updateHotel(parseInt(id), hotelData);
            ...
            if (result.success) {
                ...
                toast({
                    title: "Error",
                    description: result.message || "Failed to update hotel",
                    variant: "destructive",
                });
            }
        } catch (error) {
        ...
        <div className="max-w-4xl mx-auto p-4 space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Update hotel details.</p>
                </div>
            </div>
